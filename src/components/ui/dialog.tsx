    ...
    <DialogPortal hostName={portalHost}>
      <DialogOverlay>
        <DialogPrimitive.Content
          className={cn(
            'bg-background border-border z-50 mx-auto mt-10 flex w-full max-w-[calc(100%-2rem)] flex-col gap-4 rounded-lg border p-6 shadow-lg shadow-black/5 sm:max-w-lg',
            Platform.select({
          ...
          <DialogPrimitive.Close
            className={cn(
              'absolute right-4 top-4 4rounded opacity-70 active:opacity-100',
              Platform.select({
